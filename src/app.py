...
app_ui = ui.page_fluid(
    ui.tags.style(
        ...
        .art-card img {
            width: 55mm;        /* fixed physical width */
            height: auto;
            object-fit: contain;
            display: block;
...
def server(input, output, session):
    ...
    def load_csv():
        ...
        df = pd.read_csv(file[0]["datapath"], comment="#")
    ...
    def download_pdf():
        ...
        style = ParagraphStyle(
            name="Label", fontName="NotoSansTC", fontSize=14, leading=32
        )
